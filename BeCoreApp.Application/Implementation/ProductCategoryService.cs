...
namespace BeCoreApp.Application.Implementation
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        public List<TreeViewModel> GetTreeAll()
        {
            var listData = _productCategoryRepository.FindAll()
            ...
            var groups = listData.GroupBy(i => i.parentId);
        ...
        private void AddChildren(TreeViewModel node, IDictionary<int, List<TreeViewModel>> source)
        {
