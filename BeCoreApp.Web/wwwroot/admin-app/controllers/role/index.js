    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        be.notify('Update role successful', 'success');
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    be.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    be.stopLoading();
                },
                error: function () {
                    be.notify('Has an error in save permission progress', 'error');
                    be.stopLoading();
                }
            });
        });
