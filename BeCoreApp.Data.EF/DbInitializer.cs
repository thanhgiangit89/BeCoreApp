        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    new Function() {Id = "BLOG",Name = "Blog",ParentId = "CONTENT",SortOrder = 1,Status = Status.Active,URL = "/admin/blog/index",IconCss = ""  },
                    new Function() {Id = "PAGE",Name = "Trang Đơn",ParentId = "CONTENT",SortOrder = 2,Status = Status.Active,URL = "/admin/page/index",IconCss = ""  },
                    ...
                    new Function() {Id = "REALESTATE_MANAGEMENT", Name = "Quản Lý Rao Vặt",ParentId = null,SortOrder = 6,Status = Status.Active,URL = "/",IconCss = "	flaticon-signs"  },
                    ...
                    new Function() {Id = "PROJECT_MANAGEMENT", Name = "Quản Lý Dự Án",ParentId = null,SortOrder = 7,Status = Status.Active,URL = "/",IconCss = "	flaticon-signs"  },
